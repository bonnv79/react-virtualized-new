...
const attributeBelongsToReactVirtualizedElement = path =>
  reactVirtualizedElementNames.includes(path.parent.value.name.name);
...
const shouldAttributeBeRenamed = path =>
  attributeBelongsToReactVirtualizedElement(path) &&
